...
import Projects, {PROJECTS_STORAGE_KEY} from "./Projects"
...
describe("Projects reordering", () => {
    ...
    test("reorders cards from the keyboard handle controls", () => {
        ...
        expect(getProjectOrder()).toEqual(["E42 Store", "Portfolio", "CRM Dashboard", "Flip Clock"])
        expect(window.localStorage.getItem(PROJECTS_STORAGE_KEY)).toBe(JSON.stringify([1, 3, 2, 4]))
    })
})
