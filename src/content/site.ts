...
export const ROUTE_META: Record<string, RouteMetaEntry> = {
    ...
    "/flipclock/privacy": {
        ...
        keywords: [
            "FlipClock Display privacy",
            "FlipClock privacy policy",
            "macOS location privacy",
            "weather data privacy",
        ],
        ogType: "website",
        path: "/flipclock/privacy",
        robots: "noindex,follow",
        title: "Privacy Policy | FlipClock Display",
    },
    "/flipclock/support": {
        description: "Official support and contact information for the FlipClock Display macOS app.",
        keywords: [
            "FlipClock Display support",
            "FlipClock support email",
            "macOS clock help",
        ],
        ogType: "website",
        path: "/flipclock/support",
        title: "Support | FlipClock Display",
    },
    "/flipclock/terms": {
        description: "Terms of Use for the FlipClock Display macOS app, Pro purchases, subscriptions, and optional weather services.",
        keywords: [
            "FlipClock Display terms",
            "FlipClock terms of use",
            "macOS app terms",
        ],
        ogType: "website",
