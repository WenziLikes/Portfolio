...
These are the highest-value phrases because they match the portfolio's real stack, role, and hiring intent.
...
These support the core cluster and expand intent coverage for technical and hiring-focused queries.
...
These help with project and portfolio-intent searches.
...
| Surface | Main keyword focus |
| --- | --- |
| `/` | `full stack developer`, `react developer`, `typescript developer` |
| `/about` | `react developer`, `frontend developer`, `full stack developer` |
| `/expertise` | `react typescript developer`, `frontend architecture`, `java spring boot developer`, `remote full stack developer` |
...
- Homepage should target broad professional search intent.
...
- [Google Search Central: Discover guidance](https://developers.google.com/search/docs/appearance/google-discover)
